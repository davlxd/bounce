...
exports.reorganize_hosts_when_transfer_succeeded = function(cmd_obj) {
...
exports.reorganize_hosts_when_transfer_failed = function(cmd_obj) {
  var from_addr = cmd_obj.from;
  var to_addr = cmd_obj.to;
...
function reorganize_transfering_hosts(from_host, to_host) {
  ...
  from_host.status = 'sending to ' + to_host.host;
  to_host.status = 'receving from ' + from_host.host;
...
function provoke_trasfer(from_host, to_host) {
  ...
  superagent.post(to_host.host + ':' + cmd_port)
	...
	.end(function(error, res){
	  ...
	  reorganize_transfering_hosts(from_host, to_host);
	  do_match_hosts();
	});
    });
}
