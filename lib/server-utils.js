...
exports.change_transferred_host_status = function(cmd_obj) {
  ...
  console.log('After change transfer succeeded host status:');
  console.log('==================================');
  console.log(set0);
  console.log(set1);
  console.log('==================================');
...
exports.change_transfer_failed_host_status = function(cmd_obj) {
  ...
  console.log('After change transfer failed host status:');
  console.log('==================================');
  console.log(set0);
  console.log(set1);
  console.log('==================================');
...
function change_transfering_host_status(from_host, to_host) {
  ...
  console.log('After change transferring host status:');
  console.log('==================================');
  console.log(set0);
  console.log(set1);
  console.log('==================================');
